...
repo --name "os" --baseurl="http://mirror.centos.org/centos/7.9.2009/os/x86_64/" --cost=100
repo --name="updates" --baseurl="http://mirror.centos.org/centos/7.9.2009/updates/x86_64/" --cost=100
repo --name "extras" --baseurl="http://mirror.centos.org/centos/7.9.2009/extras/x86_64/" --cost=100
...
sed -i -e 's/$releasever/7.9.2009/g' /etc/yum.repos.d/CentOS.repo
yum-config-manager --disable base updates extras

# Import CentOS public keys
...
sed -i -e 's/7.9.2009/$releasever/g' /etc/yum.repos.d/CentOS.repo
